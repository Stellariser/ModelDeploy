...
if __name__ == '__main__':
    ...
    img1 = cv.imread('./ContinusePics/1.jpg')
    img2 = cv.imread('./ContinusePics/2.jpg')
    ...
    for i, (m, n) in enumerate(matches):
        ...
        if m.distance < 0.3*n.distance:
            good.append(m)
            if (n.distance-m.distance)<min:
                min = n.distance-m.distance
